...
export default antfu(
  {
    ...
    ignores: [
      ...
      'cli/',
      'expo-env.d.ts',
      'uniwind-types.d.ts', // generated by uniwind — not hand-editable
      'convex/_generated', // generated by Convex codegen — not hand-editable
      'migration/*',
    ],
  },

  // Custom rules (all file types — filename casing + globally relaxed rules)
  {
    rules: {
  ...
  // JS/TS-only rules — these analyze JS/TS ASTs and must not run on markdown/json/yaml
  {
    files: ['**/*.?([cm])[jt]s?(x)'],
    rules: {
      'max-params': ['error', 3],
